...
```{r eval=FALSE}
install.packages("~/Downloads/epicalc_2.15.1.0.tar.gz", repos = NULL, type = "source")
install.packages("~/Downloads/lmPerm_1.1-2.tar.gz", repos = NULL, type = "source")
```
...
#fortity函数在rmd生成pdf时报错
#tract <- ggplot2::fortify(city,region="CNTY_CODE")
#write.csv(tract,file = "tract.csv")
tract<- read.csv("/home/xuefliang/RInMedicine/tract.csv", 
                 stringsAsFactors = FALSE)
#发病数据
data <- read.csv("/home/xuefliang/RInMedicine/city/data.csv", 
                 stringsAsFactors = FALSE)
data$id <- as.character(data$id)
tract$id<- as.character(tract$id)
...
for(ss in tract$id){
  ...
  pA <- data.frame(spsample(statePoly, nA, type = "random")@coords,
                   Vote = "A") 
  #空间数据抽样，样本数nDems，抽样方法random,regular,stratified,
  #nonaliged,hexagonal,clustered,Fibonacci
