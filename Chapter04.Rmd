...
```
每组需要`r round(ISV.Equality(0.05,0.2,0.3,0.45,3))`例。
...
```
每组需要`r round(ISV.NIS(0.05,0.2,0.3,0.45,3,1.1))`例。
...
```
每组需要`r round(ISV.Equivalence(0.05,0.2,0.3,0.45,3,2))`例。
...
```
每组需要`r round(ISCV.Equality(0.05,0.2,0.7,0.5,2))`例。
...
```
每组需要`r round(ISCV.NIS(0.05,0.2,0.7,0.5,2,-0.1))`例。
...
```
每组需要`r round(ISCV.Equivalence(0.05,0.2,0.7,0.5,2,0.1))`例。
