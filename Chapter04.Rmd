...
例 实验药和对照药品治疗中风，患者先服用对照药品 1 个月，洗脱2 周，再服用试验药1 个月，另一组反之。如果 试验药能够比对照药品的有效率高 5%（差值），则认为有推广价值。预试验差值标准差为2。选用 α=0.05,Power=90%, 双侧显著性检验，需要多少样本含量? 
...
####非劣效/优效性检验
$\sigma$为率的标准差，样本容量为$n=\frac{(z_{\alpha}+z_{\beta })^{2}\sigma^2_{d}}{a(\epsilon-\delta)^{2}}$

####等效性检验
$\sigma$为率的标准差，样本容量为$n=\frac{(z_{\alpha}+z_{\beta/2 })^{2}\sigma^2_{d}}{a(\delta-|\epsilon|)^{2}}$
