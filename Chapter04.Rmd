...
Variabilities.Parallel.Equality<- function(alpha, beta, vtt, vtr) {
  ...
  n = 0
  for (i in 2:1000) {
    ratio.f = qf(p = (1 - beta), i-1, i-1, lower.tail = FALSE)/qf(alpha/2, i-1, i-1,, lower.tail = FALSE)
    if (round(ratio, digits = 2) == round(ratio.f, digits = 2)) {
      n = i
    }
  }
...
Variabilities.Parallel.NIS<- function(alpha, beta, vtt, vtr, margin) {
  ...
  n = 0
  for (i in 2:1000) {
    ratio.f = qf(p = (1 - beta), i-1, i-1, lower.tail = FALSE)/qf(alpha, i-1, i-1,, lower.tail = FALSE)
    if (round(ratio, digits = 2) == round(ratio.f, digits = 2)) {
      n = i
    }
  }
...
Variabilities.Parallel.Equivalence<- function(alpha, beta, vtt, vtr,margin) {
  ...
  n = 0
  for (i in 2:1000) {
    ratio.f = qf(beta/2, i-1, i-1, lower.tail = FALSE)/qf(p=(1-alpha), i-1, i-1,, lower.tail = FALSE)
    if (round(ratio, digits = 1) == round(ratio.f, digits = 1)) {
      n = i
    }
  }
