...
例3 有5个自变量x1～x5和1个因变量，请完成自变量的筛选。
```{r}
...
例 WHO数据集中有每10万人的HIV病人死亡率和医生的数量，试分析两变量是否有关?
...
```{r eval=FALSE}
which(names(who) == "Deaths.due.to.HIV.AIDS..per.100.000.population.per.year.")
which(names(who) == "Medical_Doctors")

source("MINE.r")
MINE("WHO.csv", c(119, 290))
