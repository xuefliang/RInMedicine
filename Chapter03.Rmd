...
output:
  ...
  pdf_document:
    ...
    number_sections: yes
    template: C:/Program Files/R/R-3.1.1/library/rticles/rmarkdown/templates/ctex/resources/default.latex
    toc: yes
...
设总体X的分布中含有未知参数$\thera,\\alpha $是任意给定的正数$(0< \alpha < 1)$，如果能从样本除服确定出两个统计量$\hat{\theta }_{1}(x_{1},x_{2},...,x_{n}),\hat{\theta }_{2}(x_{1},x_{2},...,x_{n})$，使得
